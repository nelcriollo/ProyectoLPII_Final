...
<title>Mantenimiento de devolucion de bienes</title>
<link
...
<style type="text/css">
.fondonavsup {
	background-image: radial-gradient(circle at 119.64% 37.72%, #18344a 0, #010912 50%,
		#000000 100%);
}

.fondonavbody {
	background-image: radial-gradient(circle at 119.64% 37.72%, #204177 0, #021a39 50%,
		#000000 100%);
}
...
<body>
	...
	<div id="principal" class="container">
		...
		<div class="row">
			...
			<h3 style="margin-left: 4%">Datos de Registro de Devoluciones</h3>
			<form class="form-horizontal p-4 border border-secondary">
				<div class="row my-2">
					...
					<div class="col-2">
						<div class="row">
							<button class="btn btn-dark p-1 " type="submit">Nuevo</button>
						</div>
					</div>
				</div>
				...
				<div class="row my-2">
					...
					<div class="col-2">
						<div class="row">
							<button class="btn btn-dark p-1 " type="submit">Grabar</button>
						</div>
					</div>
	...
	<footer class="text-center text-white"
		...
		<div class="container p-4">
			...
			<div class="row fs-6">
				...
				<div class="col-lg-3 mb-6 mb-lg-0">
					...
					<p>
						Central Telefónica: <br> 625-5555<br> Línea Gratuita:<br>
						0-800-00-205
					</p>
				</div>
			</div>
		...
		<div class="text-center p-3"
			style="background-color: rgba(0, 0, 0, 0.2);">© Derechos
			Reservados</div>
	</footer>
